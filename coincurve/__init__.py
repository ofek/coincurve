...
GLOBAL_CONTEXT = lib.secp256k1_context_create(ALL_FLAGS)

# Protect against certain possible future side-channel timing attacks.
lib.secp256k1_context_randomize(
    GLOBAL_CONTEXT, ffi.new('unsigned char [32]', os.urandom(32))
)
